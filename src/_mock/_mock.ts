...
export const _productNames = (index: number) =>
  [
    ...
    'Bánh Kem Matcha',
    'Bánh Kem Dâu Tây',
    'Bánh Kem Phô Mai Việt Quất',
    'Bánh Kem Tiramisu',
    'Bánh Kem Trái Cây Tươi',
    'Bánh Kem Caramel Muối',
    'Bánh Kem Red Velvet',
    'Bánh bông lan trứng muối',
    'Bánh trung thu vị thập cẩm',
    'Bánh trung thu vị trứng muối',
    'Bánh trung thu vị đậu xanh',
    'Bánh pía vị sầu riêng trứng chảy',
    'Bánh chuối nướng',
  ][index];
